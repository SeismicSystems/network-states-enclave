 ...
 *     1) No onlyOwner modifiers. Instead made leaf insertion internal.
 *     2) Hash func now absract.
 *     3) Removed leaf insertion event. Will be defined in derived class.
 *
...
abstract contract IncrementalMerkleTree {
    ...
    uint8 internal constant MAX_DEPTH = 8;
