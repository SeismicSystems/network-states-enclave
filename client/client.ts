...
async function getSignatureResponse(sig: string, uFrom: any, uTo: any) {
    ...
    const moveInputs = {
        ...
        fromIsCityTile: formattedProof.input[8],
        toIsCityTile: formattedProof.input[9],
        takingCity: formattedProof.input[10],
        takingCapital: formattedProof.input[11],
        fromCityTroops: formattedProof.input[12],
        toCityTroops: formattedProof.input[13],
        hTFrom: formattedProof.input[14],
        hTTo: formattedProof.input[15],
        hUFrom: formattedProof.input[16],
        hUTo: formattedProof.input[17],
    };
    const moveProof = {
        a: formattedProof.a,
        b: formattedProof.b,
